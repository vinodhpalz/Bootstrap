...
<html lang="en">
  ...
  <body>
	...
	<a class="dropdown-item" href="#">Previous Action Comes Here</a>
	</div>
	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
	<h2 class="dropdpwn-header">Details Header</h2>
	<a class="dropdown-item" href="#">Action</a>
	<a class="dropdown-item" href="#">Next Action</a>
	<a class="dropdown-item" href="#">Previous Action Comes Here</a>
	...
	<div class="dropdown-divider"></div>
	<a class="dropdown-item" href="#">New? Sign Up</a>
	...
	<input type="text" class="form-control-plaintext" id="InputEmail" aria-describedby="emailHelp" placeholder="Enter email">
	...
	<div class="btn-group btn-group-sm" role="group" aria-label="Group Example">
